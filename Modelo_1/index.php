...
<!-- header -->
					<header>
						<h1><a href="index.html" id="logo">DISBRALENT C.A</a></h1>
						<nav>
							<ul id="menu">								
								<li><a href="#!/page_Portfolio"><span></span><strong>Lentes de Sol</strong></a></li>
								<li><a href="#!/page_Portfolio2"><span></span><strong>Correctivos</strong></a></li>
							</ul>
						</nav>
					</header>
<!--content -->
...
<!-- footer -->
				<footer>
					...
					<div class="col_1">
						<a href="index.html" id="footer_logo">DISBRALENT C.A</a> J-29570948-0
					</div>
					<div id= "redes" class="right">
						<a href="https://www.facebook.com/DISBRALENT-CA-121695221186438/?fref=ts" target="_blank"><img width="25" heigth="25" src="images/logo-face.png"></a>
						<a href="https://twitter.com/disbralentca" target="_blank"><img width="25" heigth="25" src="images/logo-twi.png"></a>
						<a href="https://www.instagram.com/disbralentca/" target="_blank"><img width="25" heigth="25" src="images/logo-insta.png"></a>
					</div>
					<div class="col_2">
